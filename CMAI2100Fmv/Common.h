...
public:
	...
	void Set_LoadPickerUp(int nPickNo=0, int nType=0, int nNo=0);
	void Set_LoadPickerClose(int nPickNo=0, int nType=0, int nNo=0);
	void Set_LoadPickerOpen(int nPickNo=0, int nType=0, int nNo=0);
	void Set_LoadPickerDown(int nPickNo=0, int nType=0, int nNo=0);
	BOOL Get_LoadPickerOpen(int nPickNo=0, int nType=0, int nNo=0);
	BOOL Get_LoadPickerClose(int nPickNo=0, int nType=0, int nNo=0);
	BOOL Get_LoadPickerUp(int nPickNo=0);
	BOOL Get_LoadPickerDown(int nPickNo=0, int nType=0, int nNo=0);
	BOOL Get_LoadPickerCheck(int nPickNo=0, int nType=0, int nNo=0, int *nCMInfo=NULL);

	//nVisionNo(1,2,3,4) nType(0,9(개별)) nNo(0~8)
	void Set_VisionVacuumOn(int nVisionNo, int nType=0, int nNo=0);
	void Set_VisionVacuumOff(int nVisionNo, int nType=0, int nNo=0);
	BOOL Get_VisionVacuumOn(int nVisionNo, int nNo=0, int *nCMInfo=NULL);

	//nPickNo(1,2) nType(0,9(개별)) nNo(0~8)
	void Set_UnloadPickerUp(int nPickNo=0, int nType=0, int nNo=0);
	void Set_UnloadPickerClose(int nPickNo=0, int nType=0, int nNo=0);
	void Set_UnloadPickerDown(int nPickNo=0, int nType=0, int nNo=0);
	void Set_UnloadPickerOpen(int nPickNo=0, int nType=0, int nNo=0);
	BOOL Get_UnloadPickerDown(int nPickNo, int nNo=0);
	BOOL Get_UnloadPickerOpen(int nPickNo, int nNo=0);
