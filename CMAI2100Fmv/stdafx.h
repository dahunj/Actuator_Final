...
#else					
	#define MAIN_VERSION	"Vf1 3.0.3"		//C5 Final 3호기
#endif
...
#define ALIGN_TOP1_POS	0.0	//30.0
...
typedef struct {
	CString		sNGCode[6][16][40][5][10];	//Port[6],TrayNo[10],Module[40],Inspection[5],NG-Code[20]
	CString		sModuleID[6][640][10];		//Port[6],Module[320], //0:MODULEID,1:SITE,2:EQPID,3:EQPNAME,4:TOOL_CAVITY,5:PARA,6:DATE,7:ROS_JUDGE,8:DFA_LOTID,9:POCKETNO
